...
[GARBAGE]: first as a mechanism that learns the relationship between variables, and second as a mapping from queries to outputs given a set of key-value pairs.
